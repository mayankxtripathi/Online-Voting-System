...
$winners = array_keys($candidateVotes, $maxVotes);
    ...
    <div class="col-12">
        ...
        ?>
                <table class="table">
                    <thead>
                        <tr>
                            <th colspan="5" class="bg-green text-white"><h5> ELECTION TOPIC: <?php echo strtoupper($election_topic); ?></h5></th>
                        </tr>
                        <tr>
                            <th> Photo </th>
                    ...
                    while ($candidateData = mysqli_fetch_assoc($fetchingCandidates)) {
                        ...
                        $result = in_array($candidate_id, $winners) ? 'Win' : 'Lose';
                    ?>
                        <tr>
