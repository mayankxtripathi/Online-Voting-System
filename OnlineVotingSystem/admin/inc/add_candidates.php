...
if (isset($_GET['delete_id'])) {
    $candidate_id = mysqli_real_escape_string($db, $_GET['delete_id']);
...
?>
    <div class="alert alert-danger my-3" role="alert">
        Candidate image is too large, please upload a smaller file (you can upload any image up to 2MBs).
    </div>
<?php
...
?>
    <div class="alert alert-danger my-3" role="alert">
        There was an error deleting the candidate. Please try again.
    </div>
<?php
}
?>
                    ...
                    <?php 
                        ...
                        if ($isAnyElectionAdded > 0) {
                            while ($row = mysqli_fetch_assoc($fetchingElections)) {
                                ...
                                // how many candidates are added in this election 
            ...
            <tbody>
                ...
                ?>
                            <tr>
                                ...
                                <td> 
                                    <a href="index.php?addCandidatePage=1&delete_id=<?php echo $row['id']; ?>" class="btn btn-sm btn-danger">Delete</a>
                                </td>
                            </tr>   
                <?php
                        }
